let mascaras = await import($('#modulo-mascaras').attr('src'));
let { utils } = await import($('#modulo-utils').attr('src'));
let fm = await import($('#modulo-filemanager').attr('src'));

$(document).ready(function(){

  mascaras.mascarasInternas();
  utils();
  fm.manager();
