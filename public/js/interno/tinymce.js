if(document.getElementsByClassName('my-editor').length > 0){
    ...
    let css_galeria_popup = ['#tinyGaleria div.g-popup:not(:has([data-gallery]))', '#tinyGaleria :not(.g-popup, img)'];
    let editor_config = {
        path_absolute: "/",
        ...
        setup: function(editor) {
            ...
            editor.ui.registry.addButton('btnImgPopup', {
                ...
                onAction: function () {
                    let galeria = editor.dom.get("tinyGaleria");
                    ...
                    if(img.hasAttribute("src") && img.parentNode.hasAttribute("data-gallery"))
                        ...
                        let html = '<div class="col-sm-6 g-popup">';
    ...
    try {
        ...
        console.log(err);
        alert('Erro na página! Erro ao inicializar o editor!');
    }
