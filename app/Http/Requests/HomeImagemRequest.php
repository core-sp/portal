...
class HomeImagemRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'cards_laterais_1_default' => 'nullable|in:cards_laterais_1_default',
            'cards_laterais_1' => 'exclude_if:cards_laterais_1_default,cards_laterais_1_default|required_unless:cards_laterais_1_default,cards_laterais_1_default|nullable|'.$this->regex_hex,
            'cards_laterais_2_default' => 'nullable|in:cards_laterais_2_default',
            'cards_laterais_2' => 'exclude_if:cards_laterais_2_default,cards_laterais_2_default|required_unless:cards_laterais_2_default,cards_laterais_2_default|nullable|'.$this->regex_hex,
