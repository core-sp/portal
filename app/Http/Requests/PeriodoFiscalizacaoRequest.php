...
class PeriodoFiscalizacaoRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $campos .= 'autosdeinfracao,multaadministrativa,orientacaocontabil,oficioprefeitura,oficioincentivo,notificacandidatoeleicao';
        ...
        return [
            ...
            'dados.*.campo' => 'required_without:periodo|array|size:17',
            'dados.*.campo.*' => 'required_without:periodo|in:' . $campos,
            'dados.*.valor' => 'required_without:periodo|array|size:17',
