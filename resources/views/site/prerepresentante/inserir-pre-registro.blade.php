                ...
                <div class="form-row mt-2">
                    <div class="col-sm mb-2-576">
                        ...
                        <input
                            ...
                            id="cpf_cnpj"
                            value="{{ formataCpfCnpj($prerep->cpf_cnpj) }}"
                ...
                <div class="form-row">
                    <div class="col-sm mb-2-576">
                        ...
                        <input
                            ...
                            id="compr_residencia"
                            class="form-control-file border {{ $errors->has('compr_residencia') ? 'is-invalid' : '' }}"
                            value="{{ isset($resultado) ? $resultado->compr_residencia : old('compr_residencia') }}"
                            required
                        >
