                ...
                <form action="{{ route('externo.cadastro.submit') }}" method="POST" class="cadastroRepresentante">
                    ...
                    <div class="form-check mt-3">
                        ...
                        <label for="checkbox-termo-de-uso">
                            Li e concordo com os <a class="text-primary" href="{{ route('termo.consentimento.pdf', 'user-externo') }}" target="_blank">Termos de Uso</a> da Área Restrita do Login Externo do Core-SP.
                        </label>
