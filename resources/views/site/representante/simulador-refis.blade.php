            ...
            <tbody>
                ...
                <tr>
                    @if($valoresRefis['nParcelas90'][0] !== 0)
                        ...
                        <td class="ls-meio-neg"><div id="total90" value="{{ $valoresRefis['total90'] }}">R$ {{ toReais($valoresRefis['total90']) }}<p class="text-left verde-escuro strong"><small>Desconto: R$ {{ toReais($valoresRefis['total'] - $valoresRefis['total90']) }}</small></p></div></td>
                ...
                <tr>
                    @if($valoresRefis['nParcelas80'][0] !== 0)
                        ...
                        <td class="ls-meio-neg"><div id="total80" value="{{ $valoresRefis['total80'] }}">R$ {{ toReais($valoresRefis['total80']) }}<p class="text-left verde-escuro strong"><small>Desconto: R$ {{ toReais($valoresRefis['total'] - $valoresRefis['total80']) }}</small></p></div></td>
                        <td class="ls-meio-neg">
                ...
                <tr>
                    @if($valoresRefis['nParcelas60'][0] !== 0)
                        ...
                        <td class="ls-meio-neg"><div id="total60" value="{{ $valoresRefis['total60'] }}">R$ {{ toReais($valoresRefis['total60']) }}<p class="text-left verde-escuro strong"><small>Desconto: R$ {{ toReais($valoresRefis['total'] - $valoresRefis['total60']) }}</small></p></div></td>
                        <td class="ls-meio-neg">
