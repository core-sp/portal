            ...
            <div class="card-body">
              ...
              <div class="form-row mt-2">
                <div class="col">
                  ...
                  <input type="text" class="form-control {{ $errors->has('nrprocesso') ? 'is-invalid' : '' }}" placeholder="Título" name="titulo" />
                ...
                <div class="col">
                  ...
                  <div class="input-group">
                    ...
                    <input id="file" class="form-control" type="text" name="edital" />
                  </div>
                </div>
              </div>
              <div class="form-row mt-2">
