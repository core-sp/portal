...
<div class="card-body bg-light">
    ...
    <p id="cep">
        <span class="font-weight-bolder">{{ $nome_campos['cep'] }} - CEP: </span>
    ...
    <p id="bairro">
        <span class="font-weight-bolder">{{ $nome_campos['bairro'] }} - Bairro: </span>
    ...
    <p id="logradouro">
        <span class="font-weight-bolder">{{ $nome_campos['logradouro'] }} - Logradouro: </span>
    ...
    <p id="numero">
        <span class="font-weight-bolder">{{ $nome_campos['numero'] }} - Número: </span>
    ...
    <p id="complemento">
        <span class="font-weight-bolder">{{ $nome_campos['complemento'] }} - Complemento: </span>
    ...
    <p id="cidade">
        <span class="font-weight-bolder">{{ $nome_campos['cidade'] }} - Município: </span>
    ...
    <p id="uf">
        <span class="font-weight-bolder">{{ $nome_campos['uf'] }} - Estado: </span>
...
@if(!$resultado->userExterno->isPessoaFisica())
    ...
    <p id="bairro_empresa">
        <span class="font-weight-bolder">{{ $nome_campos['bairro_empresa'] }} - Bairro: </span>
    ...
    <p id="logradouro_empresa">
        <span class="font-weight-bolder">{{ $nome_campos['logradouro_empresa'] }} - Logradouro: </span>
    ...
    <p id="numero_empresa">
        <span class="font-weight-bolder">{{ $nome_campos['numero_empresa'] }} - Número: </span>
    ...
    <p id="complemento_empresa">
        <span class="font-weight-bolder">{{ $nome_campos['complemento_empresa'] }} - Complemento: </span>
    ...
    <p id="cidade_empresa">
        <span class="font-weight-bolder">{{ $nome_campos['cidade_empresa'] }} - Município: </span>
    ...
    <p id="uf_empresa">
        <span class="font-weight-bolder">{{ $nome_campos['uf_empresa'] }} - Estado: </span>
