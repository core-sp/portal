<div class="form-check border border-left-0 border-right-0 border-top-0 border-info mb-2 pl-1 {{ ($orientacao_sumario == 'vertical') && !$texto->tipoTitulo() ? 'ml-' . (string) ($texto->nivel + 2) : '' }}">
    <button type="button" 
    ...
    <label class="form-check-label ml-4 {{ ($orientacao_sumario == 'horizontal') && !$texto->tipoTitulo() ? 'pt-' . (string) ($texto->nivel + 2) : '' }}">
