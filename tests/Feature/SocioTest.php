...
class SocioTest extends TestCase
{
    ...
    public function view_pre_registro_socio_rt()
    {
        ...
        ->assertSeeInOrder([
            ...
            '<p id="registro_socio">', ' - Registro: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="nome_socio">', ' - Nome: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="nome_social_socio">', ' - Nome Social: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="dt_nascimento_socio">', ' - Data de Nascimento: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="identidade_socio">', ' - Identidade: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="orgao_emissor_socio">', ' - Órgão Emissor: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="cep_socio">', ' - CEP: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="bairro_socio">', ' - Bairro: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="logradouro_socio">', ' - Logradouro: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="numero_socio">', ' - Número: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="complemento_socio">', ' - Complemento: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="cidade_socio">', ' - Município: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="uf_socio">', ' - Estado: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="nome_mae_socio">', ' - Nome Mãe: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
            '<p id="nome_pai_socio">', ' - Nome Pai: </span>', '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '&nbsp;&nbsp;<span class="badge badge-warning pt-1">RT</span>&nbsp;&nbsp;-', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>',
    ...
    public function view_label_campo_alterado_socio_rt()
    {
        ...
        $this->get(route('preregistro.view', 1))->assertSeeInOrder([
            ...
            '<p id="cpf_cnpj_socio">', '</p>', '<p id="registro_socio">', '</p>',
            '<p id="nome_socio">', 
                '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>', '</p>',
            '<p id="nome_social_socio">', 
                '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>', '</p>',
            '<p id="dt_nascimento_socio">', 
                '<span class="font-weight-bolder">Sócio <span class="text-primary">ID 3</span>&nbsp;&nbsp;-</span>', '<button class="btn btn-link font-italic m-0 p-0 link-tab-rt" type="button">Aba "Contato / RT"</button>', '</p>',
