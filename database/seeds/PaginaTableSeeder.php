...
class PaginaTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $pagina->img = "/imagens/2019-04/institucional.png";
        $pagina->conteudo = "<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            Morbi pharetra pulvinar venenatis. Maecenas ac elit enim. Sed vel nulla nisi.
            Aenean vel enim imperdiet, lobortis libero commodo, dictum tortor.
            Ut arcu quam, semper semper aliquet sed, tempor eu leo.
            Integer pharetra accumsan diam, eget gravida felis finibus non.
